...
class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private static final float STROKE_WIDTH_LARGE = 8f;
    ...
    public CircularProgressDrawable(@NonNull Context context) {
        ...
        setStyle(LARGE);
        setStrokeWidth(STROKE_WIDTH_LARGE);
        setupAnimators();
    }
    ...
    private void setSizeParameters(float centerRadius, float strokeWidth, float arrowWidth,
        ...
        mWidth = centerRadius * 2 * screenDensity;
        mHeight = centerRadius * 2 * screenDensity;
     ...
     * the next color.
     */
    private void updateRingColor(float interpolatedTime, CircularProgressDrawable.Ring ring) {
     ...
     */
    private void applyTransformation(float interpolatedTime, CircularProgressDrawable.Ring ring, boolean lastFrame) {
        if (mFinishing) {
