...
public class ProgressNestedScrollView extends NestedScrollView implements ProgressLayout {

    private final ProgressLayoutHelper progressLayoutHelper;
    private boolean loading = false;

    public ProgressNestedScrollView(Context context) {
        this(context, null, 0);
    }

    public ProgressNestedScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ProgressNestedScrollView(Context context, AttributeSet attrs, int defStyle) {
