...
public class ProgressCoordinatorLayout extends CoordinatorLayout implements ProgressLayout {

    private final ProgressLayoutHelper progressLayoutHelper;
    private boolean loading = false;

    public ProgressCoordinatorLayout(Context context) {
        this(context, null, 0);
    }

    public ProgressCoordinatorLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ProgressCoordinatorLayout(Context context, AttributeSet attrs, int defStyle) {
